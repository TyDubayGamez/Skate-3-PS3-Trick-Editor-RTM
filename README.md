# Skate 3 Trick Editor RTM (PS3)

> **IMPORTANT:** You need .NET Framework 4.7.2 installed on your PC to run this.
...
### 1. CONNECTION
* You **MUST** have WebMan Mod / PS3MAPI running on your PS3.
* Type your PS3 IP address into the box *(Example: `10.0.0.4`)* and click **CONNECT**.
...
**Created by:** Ty Dubay (Ty Dubay Gamez)  
**Version:** 1.3.2
